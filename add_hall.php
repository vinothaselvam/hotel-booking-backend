            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <h4>Hall Booking Details</h4>
                                <div class="form-validation">
                                    
                                    <form class="form-valide"  method="post" action="pages/save_hallbooking.php" enctype="multipart/form-data">
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-digits">Hall charge:<span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-digits" name="hallcharge"  required="" onchange="calculate();" onkeyup="calculate();">
                                            </div>
                                        </div>
