...
$sql = "INSERT INTO `tbl_swimmingpool`(`customername`, `phno`, `address`,`noofpersons`, `fromdate`, `hours`,`amount`, `tax`, `taxamount`,`totalamount`, `paid`, `created_date`) VALUES ('$customername', '$phno', '$address', '$noofpersons', 
    '$fromdate', '$hours', '$amount','$taxid','$taxrupee','$taxamount','$paid', CURDATE())";
