...
{
    extract($_POST);
    $q1="UPDATE `tbl_discount` SET `discountname`='$discountname',`percentage`='$percentage',`description`='$description',`expirydate`='$expirydate' WHERE `id`='".$_GET['id']."'";
    //$q2=$conn->query($q1);
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="date" name="expirydate" class="form-control" placeholder="Expiry Date" value="<?php echo $description; ?>" required>
                                                </div>
                                            </div>
                                        </div>
