...
while($row=mysqli_fetch_array($query))
{
     ...
     $sql3 = "SELECT * FROM `tbl_hallpayment` WHERE id='".$row['id']."'";
...
?>
 ...
 <tr>
  ...
  <th align="left">Hall rental Price</th>
  <th align="left">From </th>
  <th align="left">To </th> 
  </tr>
  <tr>
 
  <td align="left">Banquet Hall</td>
  <td align="left"> <?php echo $hallcharge; ?></td> 
  <td align="left"> <?php echo $fromdate; ?></td>
  <td align="left"> <?php echo $todate; ?></td>      
  </tr>
 <tr>
  <td align="right" colspan="4"><b>Amount</b></td>
  <td align="left"><b><?php echo $taxamount; ?></b></td>
  </tr>
  <tr>
  ...
  <tr>
  <td align="right" colspan="4">Electricity Charges: </td>
  <td align="left"><?php echo $electricity_amount ?></td>
  </tr>
  <tr>
  <td align="right" colspan="4">Kitchen / Gas Charges </td>
  <td align="left"><?php echo $kitchen_amount ?></td>
  </tr>
 
   <tr>
  <td align="right" colspan="4"><b>Total Amount :</b></td>
  <td align="left"><?php echo $totalamount; ?></td>
  </tr>
  <tr>
  ...
  <td align="left"><?php echo $discountper;?>%</td>
   ...
   <tr>
  <td align="right" colspan="4"><b>Discount amount:</b></td>
  <td align="left"><?php echo $discount;?></td>
  </tr>
  

  <tr>
  <td align="right" colspan="4"><strong>Amount Paid</strong></td>
  <td align="left"><b><?php echo $amount; ?></b></td>
  </tr>
  <tr>
  <td align="right" colspan="4">Amount Due:</td>
