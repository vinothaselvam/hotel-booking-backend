                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide"  method="post" action="pages/save_customer.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-email">Any ID Proof: <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-phoneus" name="contact" placeholder="212-999-0000" minlength="10" maxlength="10" pattern="[6-9]{1}[0-9]{9}" required="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
