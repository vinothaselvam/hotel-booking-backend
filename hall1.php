...
$result=$conn->query($sql);
  ...
  $sql2 = "SELECT * FROM `tbl_rooms`WHERE id='".$row['roomname']."'";
    ...
    $totalamount = 0.0;
$totalamountperday = $_POST['hallcharge']   ;echo "<br>"; /*}*/
...
/*echo $totalamount; */
 ...
 $discountper = $discount[1];
   ...
   $taxamount = $totalamount + $total1 + $electricity_amount + $kitchen_amount  - $total2 + $swimming;
...
$paid = 0;
   ...
   $sql = "INSERT INTO `tbl_hall`(`name`,`hallcharge`, `fromdate`, `todate`, `totalamount`, `taxamount``electricity_amount `,`kitchen_amount`,`discountper`,`discount`,`paid`, `created_date` ) VALUES ('$hallcharge', '$floorno', '$fromdate', '$todate', '$taxamount', '$totalamount','$electricity_amount','$kitchen_amount','$discountper','$discount', '$paid', CURDATE()),`taxid`,`tax`,";
