                                ...
                                <div class="form-validation">
                                    ...
                                    <form class="form-valide"  method="post" action="pages/save_room.php" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="floorno" placeholder="Enter a Room number.." required="">
                                            </div>
                                        </div>
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-digits">color: <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-digits" name="amenities" placeholder="Amenities" required="">
                                            </div>
                                        </div>
